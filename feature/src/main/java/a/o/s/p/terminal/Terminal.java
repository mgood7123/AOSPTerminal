...
public class Terminal {
    ...
    private final a.o.s.p.terminal.TerminalCallbacks mCallbacks = new a.o.s.p.terminal.TerminalCallbacks() {
        @Override
    ...
    private static native long nativeInit(a.o.s.p.terminal.TerminalCallbacks callbacks);
