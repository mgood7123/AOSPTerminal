...
static JNINativeMethod gMethods[] = {
    { "nativeInit", "(Lcom/example/aospterminal/TerminalCallbacks;)J", (void*)com_android_terminal_Terminal_nativeInit },
    ...
    { "nativeGetCellRun", "(JIILcom/example/aospterminal/Terminal$CellRun;)I", (void*)com_android_terminal_Terminal_nativeGetCellRun },
...
int register_com_android_terminal_Terminal() {
    ...
    ScopedLocalRef<jclass> localClass(env,
            env->FindClass((const char *) "com/example/aospterminal/TerminalCallbacks"));
    ...
    ScopedLocalRef<jclass> cellRunLocal(env,
            env->FindClass((const char *) "com/example/aospterminal/Terminal$CellRun"));
    ...
    return jniRegisterNativeMethods(env, "com/example/aospterminal/Terminal",
